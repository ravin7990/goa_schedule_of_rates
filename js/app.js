document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateFilter(filterElement, dataKey, allText) {
        ...
        filterElement.innerHTML = `<option value="">${defaultOptionText}</option>`;
    ...
    if (document.getElementById('documentTable')) {
        if (searchInputEl) {
